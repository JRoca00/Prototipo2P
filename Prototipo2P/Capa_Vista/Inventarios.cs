...
namespace Capa_Vista
{
    public partial class Inventarios : Form
    {
        ...
        public void validaringre()
        {
            ...
            if (txtnombre.Text == "" || txtdescri.Text == "" || textBox1.Text == "")
            {
            ...
            else
            {
                ...
                TextBox[] textbox = { txtnombre, txtdescri, textBox1 };
        ...
        public void validaractua()
        {
            ...
            else
            {
                ...
                TextBox[] textbox = { txtdescri, textBox1, txtnombre };
                int valor1 = int.Parse(txtBusqueda.Text);
                string campo = "pk_inventario = ";
        ...
        private void btneliminar_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (result == DialogResult.Yes)
                {
                    ...
                    string condicion = "pk_inventario = ";
